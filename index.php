...
include "classes/home_class.php";
///////////////////////////
$msg='';
if(isset($_POST['book'])){
...
$date=$_POST['date'];
$res=new home();
$res->insertReservation($name,$phone,$date,$category);
                    ...
                    <div class="col-xl-9 col-md-9 col-md-12">
                        <div class="slider_text text-center">
                            ...
                            <h3>Fresh and Delicious Food
                                For your Health</h3>
                            <a href="menu.php" class="boxed-btn3">View Menus</a>
                        </div>
                    </div>
                </div>
            </div>
...
?>
                    <div class="col-xl-6 col-md-6 col-lg-6">
                        ...
                        <div class="single_delicious d-flex align-items-center">
                            <div class="thumb">
                                <img src="dashboard/upload/<?php echo$row['image'] ?>" style="width: 150px;" alt="food">
                            </div>
                            <div class="info">
...
?>
                            ...
                            <div class="col-xl-12">
                                <button class="sumbit_btn" type="submit" name="book">Book</button>
                            </div>
                            <div class="col-lg-6">
